const KEY="forgotten-man-void-v3";const tree=document.getElementById("treeButton"),d=document.getElementById("dialogue"),choices=document.getElementById("choices"),egg=document.getElementById("egg"),music=document.getElementById("music");
...
function choice(label,fn){let b=document.createElement("button");b.className="choice";b.textContent=label;b.onclick=e=>{e.stopPropagation();fn()};choices.appendChild(b)}
...
function start(){s.stage=1;save();play(["Well, there is a man here.","He offers you something."],()=>{choices.innerHTML="";choice("Yes",receive);choice("No",fail)})}
function receive(){s.egg=true;s.stage=2;save();egg.classList.add("visible");play(['You received the "Egg".'],()=>{choices.innerHTML="";choice("Ask for more",askMore);choice("Do Not",goodbye)})}
function askMore(){goodbye(true)}
function goodbye(fromAsk=false){s.stage=3;save();const lines=fromAsk?["Well, the man put his hand softly on your shoulder.","And, showing you his empty palm...","He put his finger to his mouth, smiled, and shook his head.","It seems you have everything.","...","He waved goodbye, looking away slightly after a moment.","...","You felt a strange melancholy.","It was a feeling that you should not look for the man anymore.","... even though you had never done such a thing in the first place."]:["He waved goodbye, looking away slightly after a moment.","...","You felt a strange melancholy.","It was a feeling that you should not look for the man anymore.","... even though you had never done such a thing in the first place."];play(lines,()=>{s.stage=4;save();hide()})}
